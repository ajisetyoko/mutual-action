...
class IO():
    ...
    def load_arg(self, argv=None):
        ...
        # argv = ['--config','config/st_gcn/kinetics-skeleton/test.yaml']#kinetics
        # argv = ['--config','config/st_gcn/kinetics-skeleton-new/train.yaml']
        # argv = ['--config','config/st_gcn/ntu-xsub-120/train.yaml']
        # argv = ['--config','config/st_gcn/ntu-xsub-120/test.yaml']
        # argv = ['--config','config/st_gcn/sbu/train.yaml']
    ...
    def get_parser(add_help=False):
        ...
        #Modified after this line, to test kinetics wo this line
#         parser.add_argument('--feeder',type = str,default=[])
